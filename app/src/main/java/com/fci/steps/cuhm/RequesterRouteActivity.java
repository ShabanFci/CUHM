...
public class RequesterRouteActivity extends FragmentActivity implements OnMapReadyCallback {
...
//    final String uId = current_user.getUid();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_requester_route);
        ...
        Curr_ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
              ...
              double lng1= Double.parseDouble(  dataSnapshot.child(uId).child("longitude").getValue().toString());
                ...
                double lat2=Double.parseDouble(  dataSnapshot.child("Li0kVFO5lkZgSoFscIgEybXCUPH2").child("latitude").getValue().toString());
                double lng2= Double.parseDouble( dataSnapshot.child("Li0kVFO5lkZgSoFscIgEybXCUPH2").child("longitude").getValue().toString());
...
//    }
    ...
    private class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            RequesterRouteActivity.ParserTask parserTask = new RequesterRouteActivity.ParserTask();
